      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">Document Summary</h2>
              <p className="text-gray-700 leading-relaxed">{documentSummary}</p>
            </div>

            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">Document Details</h2>
              <div className="space-y-2 text-sm text-gray-600">
                ...
                {data.compliance_status && (
                  <p><span className="font-medium">Compliance:</span>
