...
export default function UsageAnalytics({ data }: AdminUsageChartProps) {
  ...
  if (!isMounted) {
    return (
      <div
        className="w-full bg-white rounded-2xl shadow-sm border border-indigo-50 p-4 sm:p-6 flex items-center justify-center"
        style={{ height: 460 }}
      >
  ...
  return (
    <div className="w-full bg-white rounded-2xl shadow-sm border border-indigo-50 p-4 sm:p-6 overflow-hidden">
      <div className="mb-4">
      ...
      {/* Explicit pixel height prevents Recharts from measuring -1 */}
      <ResponsiveContainer width="100%" height={360}>
        ...
        >
          ...
          />
          <Bar dataKey="total_tokens" radius={[0, 6, 6, 0]} barSize={20}>
