      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            <p className="text-xs text-blue-700 font-medium">Merchant Contact</p>
            <p className="text-sm font-semibold text-blue-900">{merchantPhone}</p>
          </div>
        </div>
        <motion.button
 ...
 */
export const PaymentSuccessView: React.FC<PaymentSuccessViewProps> = ({ onClose }) => {
    ...
    >
      ...
      <div className="relative flex justify-center">
        ...
        <motion.div
          ...
          className="relative w-24 h-24 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/30"
        >
          {/* Checkmark Icon */}
          <motion.div
      ...
      >
        ...
        <p className="text-gray-600 max-w-sm mx-auto">
          Your Pro subscription has been activated. You now have access to unlimited document analysis and priority support.
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200 max-w-sm mx-auto"
      >
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-xl hover:from-green-700 hover:to-emerald-700 shadow-lg shadow-green-200 transition-all"
        >
        ...
        {[...Array(6)].map((_, i) => (
          ...
          >
            <div className={`w-2 h-2 rounded-full ${
              i % 3 === 0 ? 'bg-green-400' : 
              i % 3 === 1 ? 'bg-emerald-400' : 'bg-yellow-400'
            }`} />
          </motion.div>
        ))}
      </div>
    ...
    >
      ...
      <div className="grid gap-3">
        <motion.button
          ...
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="group flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 hover:border-green-400 hover:shadow-md transition-all text-left w-full"
        >
          <div className="flex items-center gap-3 pointer-events-none">
            ...
            <div>
              ...
              <p className="text-xs text-green-700 font-medium">KBZPay • WavePay • CB Pay • MMQR</p>
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="group flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 hover:border-blue-400 hover:shadow-md transition-all text-left w-full"
        >
          <div className="flex items-center gap-3 pointer-events-none">
            <motion.div 
              whileHover={{ rotate: -5 }}
            ...
            <div>
              ...
              <p className="text-xs text-blue-700 font-medium">Visa • Mastercard • PayPal</p>
            </div>
          </div>
    ...
    >
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-4 border border-indigo-200">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-bold text-indigo-700 uppercase tracking-wider">Pro Plan</span>
        ...
        <div className="grid grid-cols-1 gap-2">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-medium text-gray-700">Unlimited Documents</p>
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle className="w-3 h-3 text-green-500 flex-shrink-0" />
            <p className="text-xs font-medium text-gray-700">AI Analysis & Priority Support</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <h4 className="text-base font-bold text-gray-900 text-center">Select Payment Method</h4>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="flex gap-1">
              <span className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-[8px] font-black text-blue-700">VISA</span>
              <span className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-[8px] font-black text-red-600">MASTER</span>
            </div>
          ...
          >
            <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-black italic text-sm">P</div>
...
export const CardEntryView: React.FC<CardEntryViewProps> = ({ onProceed }) => {
  return (
    ...
    >
      {/* Card Header */}
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-4 border border-indigo-200 flex items-center justify-between">
      ...
      <div className="space-y-3">
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="w-full py-3 bg-gradient-to-r from-indigo-600 to-blue-600 text-white font-bold rounded-xl hover:from-indigo-700 hover:to-blue-700 shadow-lg shadow-indigo-200 mt-4"
        >
          Proceed to Checkout
        </motion.button>
    ...
    >
      ...
      <div className="space-y-4 text-center py-2">
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-200 mt-4"
        >
          Continue to PayPal
        </motion.button>
...
const AnimatedQRScanner: React.FC = () => {
  return (
    <div className="relative">
      ...
      >
        {/* QR Code Placeholder */}
        <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-xl flex items-center justify-center relative">
          ...
          <motion.div
            ...
            className="absolute left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-green-400 to-transparent shadow-md shadow-green-400/50"
            style={{
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {paymentStep === 'select' && (
          ...
          >
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-bold text-green-700 uppercase tracking-wider">Pro Plan</span>
                <Zap className="w-4 h-4 text-amber-500 fill-amber-500" />
              </div>
              <div className="flex items-baseline gap-1 mb-3">
                <span className="text-2xl font-black text-gray-900">15,000</span>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <MobileBankingButton
                  icon={<div className="w-6 h-6 bg-blue-600 rounded-md flex items-center justify-center text-white font-bold text-xs">K</div>}
                  name="KBZPay"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => setPaymentStep('qr')}
                  className="flex items-center gap-3 p-3 rounded-xl border-2 border-green-300 bg-gradient-to-r from-green-50 to-emerald-50 hover:border-green-400 hover:shadow-md transition-all w-full"
                >
                  ...
                  <div className="flex-1 text-left">
                    <p className="font-semibold text-gray-900 text-sm">MMQR Code</p>
                    <p className="text-xs text-green-700 font-medium">Universal QR Payment</p>
                  </div>
        ...
        {paymentStep === 'qr' && (
          ...
          >
            {/* QR Code Section */}
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 border border-gray-200 shadow-inner">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-gray-600">Open your banking app and scan the QR code above</p>
            ...
            <div className="space-y-2">
              <div className="bg-blue-50 rounded-xl p-3 border border-blue-200">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-left">
                    <p className="font-semibold text-blue-900 text-sm">Open your mobile banking app</p>
                    <p className="text-xs text-blue-700">KBZPay, WavePay, CB Pay, or any MMQR compatible app</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 rounded-xl p-3 border border-green-200">
                <div className="flex items-start gap-2">
                  <div className="w-6 h-6 bg-green-600 rounded-full flex items-center justify-center text-white font-bold text-xs flex-shrink-0">2</div>
                  <div className="text-left">
                    <p className="font-semibold text-green-900 text-sm">Scan the QR code above</p>
                    <p className="text-xs text-green-700">Amount: 15,000 MMK will be auto-filled</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 rounded-xl p-3 border border-amber-200">
                <div className="flex items-start gap-2">
                  <div className="w-6 h-6 bg-amber-600 rounded-full flex items-center justify-center text-white font-bold text-xs flex-shrink-0">3</div>
                  <div className="text-left">
                    <p className="font-semibold text-amber-900 text-sm">Complete payment & take screenshot</p>
                    <p className="text-xs text-amber-700">We'll need the transaction receipt for verification</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <motion.button
              ...
              className="w-full py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-2xl hover:from-green-700 hover:to-emerald-700 shadow-xl shadow-green-200 flex items-center justify-center gap-2"
            >
        ...
        {paymentStep === 'upload' && (
          ...
          >
            {/* Upload Section */}
            <div className="text-center mb-4">
              <h4 className="text-lg font-bold text-gray-900 mb-1">Upload Transaction Receipt</h4>
              <p className="text-sm text-gray-600">Upload a clear screenshot of your payment confirmation</p>
            </div>
            ...
            <div className="space-y-3">
                ...
                <AnimatePresence mode="wait">
                  {selectedFile ? (
                    ...
                    >
                      ...
                      <span className="text-base font-bold text-gray-900 truncate max-w-[200px]">{selectedFile.name}</span>
                      <span className="text-sm text-green-600 font-medium mt-1">✓ Receipt uploaded successfully</span>
                      <span className="text-xs text-gray-500 mt-1">Click to change receipt</span>
                    </motion.div>
                  ) : (
                    <motion.div
                      key="empty"
                    ...
                    >
                      ...
                      <span className="text-base font-bold text-gray-700">Click to upload receipt</span>
              ...
              <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-xl border border-blue-200">
                ...
                <div>
                  <p className="text-sm font-semibold text-blue-900 mb-1">Automated Verification</p>
                  <p className="text-xs text-blue-700">
                    Our system will automatically verify your payment via Supabase Realtime. 
                    You'll receive instant confirmation once verified (usually within 1-2 minutes).
                  </p>
                </div>
              </div>
