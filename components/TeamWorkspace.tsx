...
import { Users, UserPlus, Mail, X, Crown, Eye, Edit3, Trash2 } from "lucide-react"
...
export default function TeamWorkspace({ documentId }: TeamWorkspaceProps) {
              ...
              <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50 flex-shrink-0">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Team Workspace</h3>
                  </div>
                  <button
                    onClick={() => setIsOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="p-6 space-y-6">
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <h5 className="text-xs font-semibold text-gray-700 mb-2 uppercase tracking-wide">Permission Levels</h5>
                    <div className="space-y-2 text-xs text-gray-600">
                      <div className="flex items-center gap-2">
                        <Crown className="w-3 h-3 text-yellow-500" />
                        <span><strong>Owner:</strong> Full access, can manage team</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Edit3 className="w-3 h-3 text-blue-500" />
                        <span><strong>Editor:</strong> Can view and edit documents</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Eye className="w-3 h-3 text-gray-500" />
                        <span><strong>Viewer:</strong> Can only view documents</span>
                      </div>
                    </div>
                  </div>
                </div>
