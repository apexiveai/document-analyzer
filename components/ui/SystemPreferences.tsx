...
export default function SystemPreferences() {
  return (
    <div suppressHydrationWarning className="sticky top-0 z-50 w-full core-system-nav">
      <div suppressHydrationWarning className="bg-gradient-to-r from-amber-400 via-orange-400 to-pink-400 py-6 px-4 sm:px-6 shadow-md">
        <div suppressHydrationWarning className="max-w-7xl mx-auto flex flex-row items-center justify-between gap-3 sm:gap-6">
          <div suppressHydrationWarning className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
